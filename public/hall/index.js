                ...
                data.room_data.forEach(function (room_d) {
                    ...
                    for (let i = 0; i < room_data_length; i++) {
                        ...
                        data.room_info.forEach(function (room_i) {
                            ...
                            htmlContent += '<div class="col-7">';
                            htmlContent +=
                                '<h5 style="font-size: 15px;"><i class="fa-solid fa-circle-up mt-1" style="color: orange; font-size: 17px;"></i> Upgrade: <span class="text-success fw-bold">Available</span></h5>';
                            htmlContent += '</div>';
                            htmlContent += '<div class="col-5">';
                            htmlContent +=
            ...
            response.room_data.forEach(function (room_d) {
                ...
                for (let i = 0; i < room_data_length; i++) {
                    ...
                    response.room_info.forEach(function (room_i) {
                        ...
                        htmlContent += '<div class="col-7">';
                        htmlContent +=
                            '<h5 style="font-size: 15px;"><i class="fa-solid fa-tag mt-1" style="color: orange; font-size: 17px;"></i> Special Offer: <span class="text-success fw-bold">Available</span></h5>';
                        htmlContent += '</div>';
                        htmlContent += '<div class="col-5">';
                        htmlContent +=
                            '<h5 class="text-success" style="font-size: 15px;"><i class="fa-solid fa-check mt-1" style="color: green; font-size: 17px;"></i> Refundable </h5>';
